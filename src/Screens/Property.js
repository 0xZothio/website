      ...
      <div className="row">
        <div className="col-md-10 col-12 col-xl-10 col-lg-10 col-xs-12 col-sm-12 mx-auto d-flex justify-content-center align-items-center flex-column ">
          ...
          <p className="text-center mt-4">
            This property is a stunning two-story Townhome in a boutique
          ...
          <div className="col-md-10 col-12 col-xl-10 col-lg-10 col-xs-12 col-sm-12 mx-auto mt-5 text-center d-flex justify-content-center mb-5">
            <div className="d-flex flex-column mt-3 text-center"> 
              ...
              <p className="text-center mx-sm-3 mx-xs-3 mt-2">
                ...
                This property was unaffected by Hurricane Ian and comes with
                flood insurance and hurricane impact windows.<br></br> <br></br>
                Stunning two-story Townhome in a boutique building in the heart
                of South Beach. This apartment building was converted into 10
                two-story townhomes back in 2012. This 2-bedroom, 1.5-bathroom
                home is a corner unit, including modern eat-in kitchen,
                stainless steel appliances, washer/dryer, one A/C unit for each
                floor, and hurricane impact windows. Property is steps away from
                Ocean Drive, sandy beaches, and the Atlantic Ocean. The Art Deco
                district with Espanola Way & Lincoln Road are within walking
                distance. Unit includes appliances, blinds, and furniture.
                <br></br> <br></br>
